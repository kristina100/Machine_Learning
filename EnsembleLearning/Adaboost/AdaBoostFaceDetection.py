...
face_cascade = cv2.CascadeClassifier('Adaboost/Data/haarcascade_eye.xml')
eye_cascade = cv2.CascadeClassifier('Adaboost/Data/haarcascade_frontalface_default.xml')
